...
#    Nov 06, 2018 09:35:56 PM JST  platform: Windows NT
...
class EDCT_Explore:
    def __init__(self, top=None):
        ...
        self.TraitSearchEntry = ttk.Entry(self.TraitPane)
        self.TraitSearchEntry.place(relx=0.015, rely=0.073, relheight=0.038
        ...
        self.TraitGoToNext.place(relx=0.577, rely=0.073, height=26, width=23
                , bordermode='ignore')
        self.TraitGoToNext.configure(takefocus="")
        self.TraitGoToNext.configure(text='''>''')

        self.AddTrait = ttk.Button(self.TraitPane)
        self.AddTrait.place(relx=0.651, rely=0.073, height=26, width=48
                , bordermode='ignore')
        ...
        self.HideTrait.place(relx=0.799, rely=0.073, height=26, width=58
                , bordermode='ignore')
        ...
        self.FindAllTrait.place(relx=0.015, rely=0.029, height=26, width=68
                , bordermode='ignore')
        ...
        self.ReloadTraitList.place(relx=0.769, rely=0.029, height=26, width=68
                , bordermode='ignore')
        ...
        self.SaveEdit.place(relx=0.198, rely=0.029, height=30, width=68
                , bordermode='ignore')
        ...
        self.ValidEdit.place(relx=0.022, rely=0.029, height=30, width=78
                , bordermode='ignore')
        ...
        self.ReloadEdit.place(relx=0.352, rely=0.029, height=30, width=78
                , bordermode='ignore')
        ...
        self.ClearEdit = ttk.Button(self.EditPane)
        self.ClearEdit.place(relx=0.527, rely=0.029, height=30, width=58
                , bordermode='ignore')
        ...
        self.ClearEdit.configure(width=58)

        self.ExportEdit = ttk.Button(self.EditPane)
        self.ExportEdit.place(relx=0.659, rely=0.029, height=30, width=68
                , bordermode='ignore')
        ...
        self.ImportEdit = ttk.Button(self.EditPane)
        self.ImportEdit.place(relx=0.813, rely=0.029, height=30, width=78
                , bordermode='ignore')
        ...
        self.TButton2.place(relx=0.634, rely=0.058, height=30, width=38
                , bordermode='ignore')
        self.TButton2.configure(takefocus="")
        self.TButton2.configure(text='''Tbutton''')

        self.TButton3 = ttk.Button(self.TriggerPane)
        self.TButton3.place(relx=0.778, rely=0.058, height=30, width=38
                , bordermode='ignore')
