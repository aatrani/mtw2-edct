...
#    Oct 07, 2018 11:52:32 PM JST  platform: Windows NT
...
class EDCT_Explore:
    def __init__(self, top=None):
        ...
        self.TraitListt.place(relx=0.0, rely=0.119, relheight=0.879
        ...
        self.TriggerEntry.place(relx=0.03, rely=0.059, relheight=0.039
                , relwidth=0.55, bordermode='ignore')
        self.TriggerEntry.configure(textvariable=traitedit_support.traitsearched)
        self.TriggerEntry.configure(width=186)
        self.TriggerEntry.configure(takefocus="")
        self.TriggerEntry.configure(cursor="ibeam")

        self.GoToTrait = ttk.Button(self.TraitPane)
        self.GoToTrait.place(relx=0.592, rely=0.059, height=30, width=48
                , bordermode='ignore')
        self.GoToTrait.configure(command=traitedit_support.GoToTrait)
        self.GoToTrait.configure(takefocus="")
        self.GoToTrait.configure(text='''Go''')
        self.GoToTrait.configure(width=48)

        self.ViewTrait = ttk.Button(self.TraitPane)
        self.ViewTrait.place(relx=0.74, rely=0.059, height=30, width=48
                , bordermode='ignore')
        ...
        self.ViewTrait.configure(width=48)

        self.FilterTrait = ttk.Button(self.TraitPane)
        self.FilterTrait.place(relx=0.74, rely=0.015, height=30, width=48
                , bordermode='ignore')
        ...
        self.QueryTrait = ttk.Button(self.TraitPane)
        self.QueryTrait.place(relx=0.592, rely=0.015, height=30, width=48
                , bordermode='ignore')
        self.QueryTrait.configure(command=traitedit_support.QueryTrait)
        self.QueryTrait.configure(takefocus="")
        self.QueryTrait.configure(text='''Query''')
        self.QueryTrait.configure(width=48)
        ...
        self.Viewer = Text(self.EditPane)
        self.Viewer.place(relx=0.0, rely=0.119, relheight=0.88, relwidth=0.998
                , bordermode='ignore')
        ...
        self.Viewer.configure(width=454)
        self.Viewer.configure(wrap=WORD)
        ...
        self.TriggerListt.place(relx=0.0, rely=0.119, relheight=0.879
        ...
        self.TEntry2.place(relx=0.029, rely=0.059, relheight=0.039
        ...
        self.TButton2.place(relx=0.638, rely=0.059, height=30, width=38
                , bordermode='ignore')
        self.TButton2.configure(takefocus="")
        self.TButton2.configure(text='''Tbutton''')

        self.TButton3 = ttk.Button(self.TriggerPane)
        self.TButton3.place(relx=0.783, rely=0.059, height=30, width=38
                , bordermode='ignore')
